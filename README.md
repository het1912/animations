...
**1.**  Fork [this](https://github.com/het1912/animations.git) repository.

**2.**  Clone your forked copy of the project.

```
git clone --depth 1 https://github.com/<your_name>/animations
```
...
```
git remote add upstream https://github.com/het1912/animations.git
```
